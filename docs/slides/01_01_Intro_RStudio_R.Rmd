...
---
# For what do I use `r fa("r-project")`?
...
<b>.col3[Day 3: Statistical models with R]</b>
...
Get familiar with our Webex team for the group work later (5 mins):

- Go to your groups

- Start a meeting in your groups

- Briefly introduce yourself and your PhD topic to the others in your group

- Try out the chat

- Come back to the General meeting after you see my message in the General chat

--

- Change the name of your Webex profile to the name you would like to be called
  - Click on your name in the top left corner, go o `Edit Profile` and change your display name
...
# .large[Introduction to `r fa("r-project")`]
