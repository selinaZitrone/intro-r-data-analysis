...
# .large[Import and export data with readr]
...
# .large[Import excel files]

.center[![:scale 30%](img/hex-stickers/readxl.png)]

---
# Readxl

The `readxl` package is part of the tidyverse, but you need to load it explicity
