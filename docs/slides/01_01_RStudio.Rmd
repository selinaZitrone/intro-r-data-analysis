...
- Write precise instructions telling the computer what to do step by step
  - For this you need to use the language R
  
- Tell R to execute these instructions
  - R will return the result of your instructions (or an error message)

- R code is basically just text that can be saved with file extension `.R`
