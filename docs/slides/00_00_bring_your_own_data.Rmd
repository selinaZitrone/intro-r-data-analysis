...
- Group 1 (own data): Franz, Nilofer, Franziska, Charlotte
...
The [`EcoData` R package](https://github.com/TheoreticalEcology/ecodata) includes many different data sets.
...
Please take another 5-10 mins to complete my more specific survey to further improve the course
