...
Note: dividing a vector of length n by a vector of lenght 1 (i.e. a single number), the result is a vector of lenght n again.
...
- Which species have brain weight larger than the mean brain weight?
