...
- select only rows that belong to the order of primates, rodentia and carnivora (hint: `%in%`)
...
Create two subsets of the data for large and small brained animals and calculate the mean and standard deviation of the brain to body ratio in these subsets.
