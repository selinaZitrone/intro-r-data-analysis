Create a new script for this task.
...
- Calculate mean and standard deviation of the brain weight (hint: have a look at the summary slides to find the functions)
...
- Are there any animals with a larger brain to body ratio than humans? If yes, which ones?
  - Hint: find the ratio for humans and save it in a separate variable first
