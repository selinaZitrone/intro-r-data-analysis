...
1. ... `penguins` to find penguins with lowest body mass

2. ... `penguins` to find penguins with highest body mass

3. ... `penguins` by species and sex, with longest flippers first
...
2. ... with the ratio of bill length to bill depth
