...
Free tier available, Pro plan: 20$ per month (5$ for students)
...
- Risk of **over-reliance** — you stop thinking critically

## Things to consider I

- **Privacy**
  - Check privacy guidelines before you use tools (e.g. `Github -> Settings -> Copilot -> Policies`)
- **Plagiarism**
  - Block suggestions matching public code (`Github -> Settings -> Copilot -> Policies`)

## Things to consider II

- **Responsibility**
  - You are responsible for your scientific output
  - Review and double-check AI-generated code
- **Transparency**
