...
- Built into RStudio — no extra installation needed
...
Open RStudio and go to `File -> New File -> Quarto Document`

. . .

![](img/day3/new_quarto_doc.jpg)

. . .

Click `Create` and the file opens in RStudio.
...
- Add some text with headers and formatting
- Add code chunks with gapminder plots
- Use inline code
- Render to HTML
...
You might need to install TinyTeX first (only once):
````r
...
Switch between **Source** and **Visual** mode using the buttons at the top of the editor.
