...
- Look [here](https://www.tidyverse.org/blog/2025/10/ggplot2-styling/) for an overview of the elements that you can change
...
g +
  ...
  theme(
    ...
    plot.title = element_text(color = "#c06a38ff")
  )
```
