---
title: "Task: Data visualization with ggplot2"
...
<p class="r_class_solution" style="display:none">
  <a href="../solutions/ggplot-solution.html" target="_blank">Click here for the solution.</a>
</p>
```
:::
...
A helpful resource to consult for this task can be the [ggplot2 cheatsheet](https://raw.githubusercontent.com/rstudio/cheatsheets/master/data-visualization-2.1.pdf){target="_blank"}.
...
- Just type `penguins` in the console and you should see the `penguins` data printed in the console
...
Explore the data set and it's variables using ggplot. 
Below, you find some suggestions for plots. You don't have to do all of them, just pick the ones you find most interesting. 
If you have your own plot ideas, feel free to deviate from the tasks. 

Don't worry about the beauty of your plots, yet. 
This task is about exploring the data and testing different visualization options.
Making them look pretty will be the task in the next section. 
...
First, choose one of the the tasks 1.3.1 or 1.3.2, then do task 1.4 on saving plots. If you still have time, you can come back to the task you didn’t do.
