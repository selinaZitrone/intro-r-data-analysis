...
Save one of the plots to a dedicated plot folder in your RStudio project. You try 
different formats, e.g. `.png` or `.pdf`.

Note: Make sure the path where you save the plot exists. If you e.g. want to save in
