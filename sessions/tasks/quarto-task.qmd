...
:::{.callout-tip}
Render your document often (`Ctrl + Shift + K`) to check if everything still works. It's much easier to find mistakes if you render after every small change.
:::
...
# Install TinyTeX (only run this once)
