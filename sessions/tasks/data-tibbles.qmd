---
title: "Task: Data frames and tibbles"
number-sections: false
---

[← Back to session page](../04_data-tibbles.qmd)
...
- If you haven't already, install the tidyverse by calling `install.packages("tidyverse")` in the console.
  - You don't need to put this command in your script as you only need to call it once to install the packages
- Open your script for the task and put `library(tidyverse)` on top
- Execute this line and the tidyverse packages (including tibble) are loaded into your R session

## Create a tibble

Use the vectors `species`, `brainwt_kg`, `bodywt_kg` from the [previous task](intro-r.qmd) and combine them in a tibble.
