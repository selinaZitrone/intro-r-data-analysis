...
- Download the csv or excel file from below that have a metadata on top and a messy header.
  Try reading it into R correctly and clean the column names using the `janitor::clean_names` function
