---
title: "Task: Tidy data with tidyr"
number-sections: false
---

[← Back to session page](../09_tidyr.qmd)
...
<p class="r_class_solution" style="display:none">
  <a href="../solutions/tidyr-solution.html" target="_blank">Click here for the solution.</a>
</p>
```
:::
...
A helpful resource for this task is the [tidyr cheatsheet](https://rstudio.github.io/cheatsheets/tidyr.pdf){target="_blank"}.
...
Each row indicates that a fish was detected (seen = 1) at a particular station.
