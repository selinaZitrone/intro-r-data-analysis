...
The column `Organic Matter (%)` has spaces and special characters. Use `janitor::clean_names()` to fix this:
...
The column name is now `organic_matter_percent` — no spaces, no special characters, all lowercase.
