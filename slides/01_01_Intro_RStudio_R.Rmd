...
<b>.col2[Day 1: Introduction to R and RStudio]</b>
...
If you want to bring your own data set on the last day:

- send it to me via email with a short description
  - I will check if the data is suitable
  - I will let you know what you have to do to prepare the data set to make it easier to work with

- Tomorrow we will learn about good practices for data preparation

--

- Add your data set to our [joint document](https://hackmd.io/@selinaZitrone/r12pL71C_/edit)

- Others can go through the list and add their names to the data set they are interested in working on
...
You can also add them to the feedback section of our [joint document]([joint document](https://hackmd.io/@selinaZitrone/r12pL71C_/edit) whenever something comes to your mind 
...
.right-column[
```{r relational operators 2, eval=TRUE}
2 < 4
2 > 4
2 <= 2
33 >= 32
...
- returns only 3 values for population, because Stockholm is not a city in our vector
  - no city in `cities` returns `TRUE` for the test against `"Stockholm"`
...
## Task 1-2: Data types and vectors
