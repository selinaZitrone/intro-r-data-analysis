...
- within one column, all values are of the .col3[same data type]
...
.strong[.center[ tibble [ .col1[row_index], .col2[col_index or col_name] ]]]
...
<b>.center[tibble [ .col1[logical vector of length nrow(tibble)], .col2[cols to select] ]]]</b>
...
**Idea:**<br>
1. Create a subset of only the numbers you want to change
