...
.middle[
![:scale 100%](img/day2/datascience_workflow_tidyverse.png)]
...
# .large[Data visualization with ggplot2]

.center[![:scale 30%](img/hex-stickers/ggplot2.png)]
...
We can add a smoothing line that helps us see patterns in the data
...
## Task 2-1: Create your own penguin ggplots
