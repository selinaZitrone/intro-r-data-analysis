...
.strong[.col1[function_name] ( .col2[argument] = .col3[value] )]
...
<br>
 .strong[.col1[mean] ( .col2[x] = .col3[c(1,5,6)] )]
...
--
- Functions are called by their name, followed by parentheses: `functionName()`
--
- Functions from additional packages can be called like this: `packageName::functionName()`
--
