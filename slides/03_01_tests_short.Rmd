...
---
# Classical approach in statistics

.center[![:scale 60%](img/day3/statistics_approach.png)]
...
ggplot(InsectSprays, aes(x=spray, y=count, fill = spray))+
  ...
  scale_fill_manual(values = c("orange", "cyan4", "white", "white", "purple", "white"))+
...
Result: The variances of sprays A and E differ significantly (F-Test, $F_{11,11}$ = 7.42, p = 0.002)
...
**Result:** The means of spray A and E do differ significantly (t = 7.58, df = 13.9, p < 0.001)
...
**Result:** The means of spray A and E do not differ significantly (W = 62, p = 0.58)
